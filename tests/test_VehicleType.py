...
def test_raises_negative_max_overtime():
    with assert_raises(ValueError):
        VehicleType(max_overtime=-1)


def test_raises_negative_duration_cost():
    with assert_raises(ValueError):
...
def test_default_values():
    ...
    assert_equal(vehicle_type.duration_cost, zero)
...
def test_attribute_access():
    ...
    vehicle_type = VehicleType(
        ...
        start_late=18,
        max_overtime=43,
        duration_cost=PiecewiseLinearFunction([(0, 5), (10, 15)]),
    ...
    assert_equal(
        ...
        PiecewiseLinearFunction([(0, 5), (10, 15)]),
    )
