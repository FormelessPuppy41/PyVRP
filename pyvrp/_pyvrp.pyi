...
class ProblemData:
    def __init__(
        ...
        edge_demand_matrices: list[list[np.ndarray[int]]] = [],
    ) -> None: ...
    ...
    def edge_demand_matrices(self) -> list[list[np.ndarray[int]]]: ...
    def replace(
        self,
        ...
        edge_demand_matrices: list[list[np.ndarray[int]]] | None = None,
    ) -> ProblemData: ...
    ...
    def edge_demand_matrix(
        self, profile: int, dimension: int
    ) -> np.ndarray[int]: ...
    def has_time_windows(self) -> bool: ...
    def has_edge_demands(self) -> bool: ...
    @property
